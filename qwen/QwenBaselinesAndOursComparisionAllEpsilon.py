...
for epsilon in allEpsilons:
    ...
    for attck_type in all_attck_types:
        ...
        np.save(f"qwen/BertRougLists/perAttackSampleBERTscoresPrecision_attck_type_{attck_type}_epsilon_{epsilon}_NumattackSamples_{attackSample}_.npy", sampleAggP)
        np.save(f"qwen/BertRougLists/perAttackSampleBERTscoresRecall_attck_type_{attck_type}_epsilon_{epsilon}_NumattackSamples_{attackSample}_.npy", sampleAggR)
        np.save(f"qwen/BertRougLists/perAttackSampleBERTscoresF1Score_attck_type_{attck_type}_epsilon_{epsilon}_NumattackSamples_{attackSample}_.npy", sampleAggF1)
