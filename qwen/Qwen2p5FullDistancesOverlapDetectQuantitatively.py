...
for StudyLayer in $(seq 0 27); do
    python qwen/Qwen2p5FullDistancesOverlapDetectQuantitatively.py --attck_type bsa --desired_norm_l_inf 0.005 --thickEpsilon 0.05 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --VisionLayerTrack 0 --LanLayerTrack $StudyLayer --kthSingVec -10 --attackMode lan --attackSample 5
done

python qwen/Qwen2p5FullDistancesOverlapDetectQuantitatively.py --attck_type bsa --desired_norm_l_inf 0.005 --thickEpsilon 0.5 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --VisionLayerTrack 0 --LanLayerTrack 0 --kthSingVec -10 --attackMode lan --attackSample 2



for StudyLayer in $(seq 0 27); do
    python qwen/Qwen2p5FullDistancesOverlapDetectQuantitatively.py --attck_type nllm --desired_norm_l_inf 0.0025 --thickEpsilon 0.05 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --VisionLayerTrack 0 --LanLayerTrack $StudyLayer --kthSingVec -10 --attackMode lan --attackSample 5
done

for StudyLayer in $(seq 0 27); do
    python qwen/Qwen2p5FullDistancesOverlapDetectQuantitatively.py --attck_type ega --desired_norm_l_inf 0.0025 --thickEpsilon 0.05 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --VisionLayerTrack 0 --LanLayerTrack $StudyLayer --kthSingVec -10 --attackMode lan --attackSample 5
done
...
for StudyLayer in $(seq 0 31); do
    python qwen/Qwen2p5FullDistancesOverlapDetectQuantitatively.py --attck_type bsa --desired_norm_l_inf 0.005 --thickEpsilon 0.05 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --VisionLayerTrack $StudyLayer --LanLayerTrack 0 --kthSingVec 10 --attackMode vis --attackSample 2
done
...
export PYTHONNOUSERSITE=1
for StudyLayer in $(seq 0 27); do
    python qwen/Qwen2p5FullDistancesOverlapDetectQuantitatively.py --attck_type bsa --desired_norm_l_inf 0.005 --thickEpsilon 0.5 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --VisionLayerTrack 0 --LanLayerTrack $StudyLayer --kthSingVec -10 --attackMode lan --attackSample 2
done
...
export PYTHONNOUSERSITE=1
for StudyLayer in $(seq 0 31); do
    python qwen/Qwen2p5FullDistancesOverlapDetectQuantitatively.py --attck_type bsa --desired_norm_l_inf 0.005 --thickEpsilon 0.5 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --VisionLayerTrack $StudyLayer --LanLayerTrack 0 --kthSingVec 10 --attackMode vis --attackSample 2
done
...
def main():
    ...
    #testCheck_delta = torch.randn_like(best_delta) * epsilon
    ...
    for i in range(len(FlattenedAlignmentDistributionsOriginal)):
        ...
        #diffStrong = (adv_c).pow(2).mean(dim=token_dim).sqrt().flatten()
        #diffWeak = (weak_c).pow(2).mean(dim=token_dim).sqrt().flatten()
        ...
        #print("diffStrong.shape", diffStrong.shape)

        #print("diffWeak.shape", diffWeak.shape)
    ...
    for i in range(len(averagedAggregationOverFlattenedAlignmentDistributionsOriginal)):
            ...
            print("probs * 100", curDetScore)

            #label = point_labels[i].replace("\n", " ")

            #save_dir = f"qwen/DetechScores"

            #os.makedirs(save_dir, exist_ok=True)

            #weak_vs_strong_l2 = float(np.linalg.norm(strong - weak))
            '''csv_path = os.path.join(save_dir, f"DetectionScores{attackMode}_attck_type_{attck_type}_epsilon_{epsilon}_thickEpsilon_{thickEpsilon}_attackSample_{attackSample}_.csv")
