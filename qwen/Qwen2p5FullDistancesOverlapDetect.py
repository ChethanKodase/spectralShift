...
for StudyLayer in $(seq 0 27); do
    python qwen/Qwen2p5FullDistancesOverlapDetect.py --attck_type bsa --desired_norm_l_inf 0.0025 --thickEpsilon 0.05 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --VisionLayerTrack 0 --LanLayerTrack $StudyLayer --kthSingVec -10 --attackMode lan --attackSample 5
done



for StudyLayer in $(seq 0 27); do
    python qwen/Qwen2p5FullDistancesOverlapDetect.py --attck_type nllm --desired_norm_l_inf 0.0025 --thickEpsilon 0.05 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --VisionLayerTrack 0 --LanLayerTrack $StudyLayer --kthSingVec -10 --attackMode lan --attackSample 5
done

for StudyLayer in $(seq 0 27); do
    python qwen/Qwen2p5FullDistancesOverlapDetect.py --attck_type ega --desired_norm_l_inf 0.0025 --thickEpsilon 0.05 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --VisionLayerTrack 0 --LanLayerTrack $StudyLayer --kthSingVec -10 --attackMode lan --attackSample 5
done
...
for StudyLayer in $(seq 0 31); do
    python qwen/Qwen2p5FullDistancesOverlapDetect.py --attck_type bsa --desired_norm_l_inf 0.005 --thickEpsilon 0.05 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --VisionLayerTrack $StudyLayer --LanLayerTrack 0 --kthSingVec 10 --attackMode vis --attackSample 2
done
...
export PYTHONNOUSERSITE=1
for StudyLayer in $(seq 0 27); do
    python qwen/Qwen2p5FullDistancesOverlapDetect.py --attck_type bsa --desired_norm_l_inf 0.005 --thickEpsilon 0.5 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --VisionLayerTrack 0 --LanLayerTrack $StudyLayer --kthSingVec -10 --attackMode lan --attackSample 2
done
...
export PYTHONNOUSERSITE=1
for StudyLayer in $(seq 0 31); do
    python qwen/Qwen2p5FullDistancesOverlapDetect.py --attck_type bsa --desired_norm_l_inf 0.005 --thickEpsilon 0.5 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --VisionLayerTrack $StudyLayer --LanLayerTrack 0 --kthSingVec 10 --attackMode vis --attackSample 2
done
