...
for StudyLayer in $(seq 0 27); do
    python qwen/Qwen2p5FullDistancesOverlap.py --attck_type bsa --desired_norm_l_inf 0.0009 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --VisionLayerTrack 0 --LanLayerTrack $StudyLayer --kthSingVec -10 --attackMode lan
done
...
for StudyLayer in $(seq 0 31); do
    python qwen/Qwen2p5FullDistancesOverlap.py --attck_type bsa --desired_norm_l_inf 0.0009 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --VisionLayerTrack $StudyLayer --LanLayerTrack 0 --kthSingVec 10 --attackMode vis
done


python qwen/Qwen2p5FullDistancesOverlap.py --attck_type bsa --desired_norm_l_inf 0.0009 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --VisionLayerTrack 0 --LanLayerTrack 1 --kthSingVec -10 --attackMode lan




python qwen/Qwen2p5FullDistancesOverlap.py --attck_type bsa --desired_norm_l_inf 0.0009 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --VisionLayerTrack 0 --LanLayerTrack 0 --kthSingVec -10 --attackMode vis
