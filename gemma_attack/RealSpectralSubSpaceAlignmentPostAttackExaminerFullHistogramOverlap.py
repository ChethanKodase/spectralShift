...
for StudyLayer in $(seq 0 33); do
    python gemma_attack/RealSpectralSubSpaceAlignmentPostAttackExaminerFullHistogramOverlap.py --attck_type saa_BSAexp --desired_norm_l_inf 0.005 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --VisionLayerTrack 0 --LanLayerTrack $StudyLayer --kthSingVec -10 --attackMode lan
done
...
for StudyLayer in $(seq 0 26); do
    python gemma_attack/RealSpectralSubSpaceAlignmentPostAttackExaminerFullHistogramOverlap.py --attck_type saa_BSAexp --desired_norm_l_inf 0.005 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --VisionLayerTrack $StudyLayer --LanLayerTrack 0 --kthSingVec 10 --attackMode vis
done


python gemma_attack/RealSpectralSubSpaceAlignmentPostAttackExaminerFullHistogramOverlap.py --attck_type saa_BSAexp --desired_norm_l_inf 0.005 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --VisionLayerTrack 0 --LanLayerTrack 1 --kthSingVec -10 --attackMode lan





python gemma_attack/RealSpectralSubSpaceAlignmentPostAttackExaminerFullHistogramOverlap.py --attck_type saa_BSAexp --desired_norm_l_inf 0.005 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --VisionLayerTrack 0 --LanLayerTrack 0 --kthSingVec -10 --attackMode vis
...
def getMeanAlignmentWithTopRightSingularVector(InputToLayer, topRightSingularVector):
    ...
    return mean_energy, coeffs.mean(dim=1)
...
def main():
    ...
    for i in range(len(averagedAggregationOverFlattenedAlignmentDistributionsOriginal)):
            ...
            save_dir = f"gemma_attack/OverlapHistoGramsAvg"
