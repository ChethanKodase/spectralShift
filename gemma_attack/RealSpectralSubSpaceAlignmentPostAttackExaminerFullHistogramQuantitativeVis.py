...
cd spectralShift
python gemma_attack/RealSpectralSubSpaceAlignmentPostAttackExaminerFullHistogramQuantitativeVis.py --attck_type saa_BSAexp --desired_norm_l_inf 0.005 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --attackMode vis
...
def main():
    ...
    csv_path = "gemma_attack/outputsStorageImagenet/alignment_shift_sweepVis.csv"
    write_header = not os.path.exists(csv_path)

    for VisionLayerTrack in range(34):
        LanLayerTrack = 0
