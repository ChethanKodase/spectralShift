...
# MODIFIED vs gemma_attack/GemmaDetectEachAdversary.py: functional behavior
# (result bookkeeping + saved .npy files) ported from
# qwen/Qwen2p5DetectEachAdversary.py -- adds --detectionThreshold and saves
# ProbMaxes / ProbMins / ChancesYouHit .npy files under
# gemma_attack/allProbMaxes, using the exact same filename convention as the
# Qwen detector. Model loading, image loading, attack-noise loading, and
...
cd spectralShift
python gemma_attack/GemmaDetectEachAdversaryNew.py --attck_type bsa --desired_norm_l_inf 0.005 --thickEpsilon 0.03 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --kthSingVec -10 --attackMode lan --detectionThreshold 0.9
python gemma_attack/GemmaDetectEachAdversaryNew.py --attck_type bsa --desired_norm_l_inf 0.004 --thickEpsilon 0.03 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --kthSingVec -10 --attackMode lan --detectionThreshold 0.9
python gemma_attack/GemmaDetectEachAdversaryNew.py --attck_type bsa --desired_norm_l_inf 0.003 --thickEpsilon 0.03 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --kthSingVec -10 --attackMode lan --detectionThreshold 0.9
python gemma_attack/GemmaDetectEachAdversaryNew.py --attck_type bsa --desired_norm_l_inf 0.002 --thickEpsilon 0.03 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --kthSingVec -10 --attackMode lan --detectionThreshold 0.9
...
conda activate gemma3
cd spectralShift
python gemma_attack/GemmaDetectEachAdversaryNew.py --attck_type nllm --desired_norm_l_inf 0.005 --thickEpsilon 0.03 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --kthSingVec -10 --attackMode lan --detectionThreshold 0.9
python gemma_attack/GemmaDetectEachAdversaryNew.py --attck_type nllm --desired_norm_l_inf 0.004 --thickEpsilon 0.03 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --kthSingVec -10 --attackMode lan --detectionThreshold 0.9
python gemma_attack/GemmaDetectEachAdversaryNew.py --attck_type nllm --desired_norm_l_inf 0.003 --thickEpsilon 0.03 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --kthSingVec -10 --attackMode lan --detectionThreshold 0.9
python gemma_attack/GemmaDetectEachAdversaryNew.py --attck_type nllm --desired_norm_l_inf 0.002 --thickEpsilon 0.03 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --kthSingVec -10 --attackMode lan --detectionThreshold 0.9


export CUDA_VISIBLE_DEVICES=5
conda activate gemma3
cd spectralShift
python gemma_attack/GemmaDetectEachAdversaryNew.py --attck_type ega --desired_norm_l_inf 0.005 --thickEpsilon 0.03 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --kthSingVec -10 --attackMode lan --ega_ratio 0.2 --detectionThreshold 0.9
python gemma_attack/GemmaDetectEachAdversaryNew.py --attck_type ega --desired_norm_l_inf 0.004 --thickEpsilon 0.03 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --kthSingVec -10 --attackMode lan --ega_ratio 0.2 --detectionThreshold 0.9
python gemma_attack/GemmaDetectEachAdversaryNew.py --attck_type ega --desired_norm_l_inf 0.003 --thickEpsilon 0.03 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --kthSingVec -10 --attackMode lan --ega_ratio 0.2 --detectionThreshold 0.9
python gemma_attack/GemmaDetectEachAdversaryNew.py --attck_type ega --desired_norm_l_inf 0.002 --thickEpsilon 0.03 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --kthSingVec -10 --attackMode lan --ega_ratio 0.2 --detectionThreshold 0.9


export CUDA_VISIBLE_DEVICES=6
conda activate gemma3
cd spectralShift
python gemma_attack/GemmaDetectEachAdversaryNew.py --attck_type justNoise --desired_norm_l_inf 0.005 --thickEpsilon 0.03 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --kthSingVec -10 --attackMode lan --detectionThreshold 0.9
python gemma_attack/GemmaDetectEachAdversaryNew.py --attck_type justNoise --desired_norm_l_inf 0.004 --thickEpsilon 0.03 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --kthSingVec -10 --attackMode lan --detectionThreshold 0.9
python gemma_attack/GemmaDetectEachAdversaryNew.py --attck_type justNoise --desired_norm_l_inf 0.003 --thickEpsilon 0.03 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --kthSingVec -10 --attackMode lan --detectionThreshold 0.9
python gemma_attack/GemmaDetectEachAdversaryNew.py --attck_type justNoise --desired_norm_l_inf 0.002 --thickEpsilon 0.03 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --kthSingVec -10 --attackMode lan --detectionThreshold 0.9
...
def adam_attack_original_space(
    ...
    # ADDED (ported from qwen/Qwen2p5DetectEachAdversary.py): justNoise
    # ignores the loaded delta entirely and perturbs with fresh random noise
    ...
    # MODIFIED (ported from qwen/Qwen2p5DetectEachAdversary.py): the weakened
    # pass now perturbs x_adv01_created (the strong/justNoise adversary just
...
def main():
    ...
    # ADDED vs GemmaDetectEachAdversary.py (ported from
    # qwen/Qwen2p5DetectEachAdversary.py): detection threshold used to count
